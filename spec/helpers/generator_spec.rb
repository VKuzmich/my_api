...
RSpec.describe Generator, type: :helper do
  ...
  describe 'initialization' do
    ...
    context 'checking .generating_mix with the value of numbers of symbols' do
      ...
      it 'method receives zero numbers of symbols and raise ArgumentError' do
        expect do
          generator.generating_mix(zero_number_of_symbols)
        end.to raise_error(ArgumentError)
      end

      it 'method receives negative symbols numbers and raise ArgumentError' do
        expect do
          generator.generating_mix(negative_number_of_symbols)
        end.to raise_error(ArgumentError)
      end
    end
  end
